#### 這章進入NeuralNetwork, 
- 介紹 Deep Learning 大致流程(由perceptron演變而來)
...
#### pythonScript:
inference.py: 我寫的inference範例，用minist資料集中的測試資料對此100張資料算出它的正確率(正確次數 / 總資料數(100張28x28的灰階影像))

functions.py 作者寫好的，裡面放sigmoid, softmax等函數

__init__.py 是建構子 應該是呼叫那些python script時生的吧

mnist.py 用來載入MINIST資料集的 function集 (deepLearning作者幫我寫的)

mnist_show.py 用來顯示MINIST資料集的圖片，看看裡面影像資料長怎樣，我照著寫的
